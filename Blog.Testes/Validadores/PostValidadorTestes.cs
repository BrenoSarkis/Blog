...
namespace Blog.Testes.Validadores
{
    ...
    public class PostValidadorTestes
    {
        ...
        {
            var post = new Post(titulo: "", autor: "Breno", data: DateTime.Today);
        ...
        [Test]
        public void Criar_PostSemAutor_GeraNotificacao()
        {
            var post = new Post(titulo: "Teste", autor: "", data: DateTime.Today);
            var validador = new PostValidador(post, this.centralDeNotificacao);

            validador.Validar();

            Assert.True(this.centralDeNotificacao.ErrosContemCodigo("ERR002"));
        }
    ...
    public class Post
    {
        public Post(string titulo, string autor, DateTime data)
        {
            Titulo = titulo;
            Autor = autor;
            Data = data;
    ...
    public class PostValidador
    {
        ...
        public void AutorFoiInformado()
        {
            if (String.IsNullOrWhiteSpace(post.Autor)) this.centralDeNotificacao.AdicionarErro("ERR002");
        }
