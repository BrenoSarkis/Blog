...
namespace Blog.Web.App_Start
{
    ...
    using Fronteiras.Executores.ListarPosts;
    using Apresentadores;
    ...
    public static class NinjectWebCommon 
    {
        ...
        {
            InversorDeControle.Instalar(kernel);
            kernel.Bind<IListarPostsApresentador>().To<ListarPostsApresentador>();
        }        
    }
